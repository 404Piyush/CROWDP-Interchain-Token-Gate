  ...
  return (
    <div className="space-y-6">
        ...
        {roleInfo.currentRole ? (
          ...
          <div className="space-y-3">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-lg font-semibold text-white/70 font-poppins">
                No Role Assigned
              </span>
            </div>
            <p className="text-white/80 font-poppins">
        ...
        <div className="bg-white/20 backdrop-blur-sm rounded-xl p-6 border border-white/30">
          ...
          <div className="space-y-4">
            ...
            <button
              onClick={assignRoles}
              disabled={assigning}
              className="w-full bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 disabled:from-gray-500 disabled:to-gray-600 text-white font-bold py-3 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg shadow-green-500/25 font-button disabled:cursor-not-allowed disabled:transform-none"
            >
            ...
            {assignmentResult && (
              <div className="p-3 bg-black/30 rounded-lg">
                <p className="text-white font-poppins text-sm">{assignmentResult}</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="bg-white/20 backdrop-blur-sm rounded-xl p-6 border border-white/30">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              <span className="text-white font-poppins">{roleInfo.nextRole.name}</span>
              <span className="text-white/70 font-poppins">{roleInfo.nextRole.threshold} OSMO</span>
            </div>
      ...
      <div className="bg-white/10 rounded-xl p-4">
        ...
        <div className="space-y-1 text-sm text-black/80 font-poppins">
